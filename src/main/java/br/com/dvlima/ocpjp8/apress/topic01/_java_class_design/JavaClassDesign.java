package br.com.dvlima.ocpjp8.apress.topic01._java_class_design;
...
//	methods.
//	 If youre using an object in containers like HashSet or HashMap, make sure you
...
//	Provide only accessor methods (i.e., getter methods) but dont provide mutator
