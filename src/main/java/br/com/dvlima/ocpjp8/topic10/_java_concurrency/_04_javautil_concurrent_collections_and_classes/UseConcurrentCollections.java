package br.com.dvlima.ocpjp8.topic10._java_concurrency._04_javautil_concurrent_collections_and_classes;

import java.util.concurrent.BrokenBarrierException;
import java.util.concurrent.CyclicBarrier;

public class UseConcurrentCollections {
    public static void main(String args[]) throws InterruptedException, BrokenBarrierException {
        ...
        PassengerThread p3 = new PassengerThread(5000, barrier, "Joya");
